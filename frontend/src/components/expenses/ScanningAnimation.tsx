...
const ScanningAnimation: React.FC<ScanningAnimationProps> = ({
  ...
  return (
    <div className={cn("relative w-full h-full overflow-hidden", className)}>
      <div
        className="absolute left-0 w-full h-1 bg-primary opacity-70 transition-all duration-100"
        style={{
          top: `${scanPosition * 100}%`,
          boxShadow: '0 0 10px 2px rgba(59, 130, 246, 0.5), 0 0 20px 10px rgba(59, 130, 246, 0.2)'
        }}
      />
      <div
        className="absolute left-0 w-full h-20 bg-gradient-to-b from-primary/10 to-transparent pointer-events-none transition-all duration-100"
        style={{
          top: `${scanPosition * 100}%`,
